...
export class Test1622449914656 implements MigrationInterface {
    name = 'Test1622449914656'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "customer" ("id" SERIAL NOT NULL, CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`);
